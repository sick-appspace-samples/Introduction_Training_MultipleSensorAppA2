## Introduction_Training_MultipleSensorAppA2
SampleApp A for running multiple SensorApps
...
The purpose of this one is to be the first of several in parallel running
SensorApps on one device and interact via a served event with the second one.

### Topics
training, introduction, multiple, served, event, sampleapp, sick-appspace
